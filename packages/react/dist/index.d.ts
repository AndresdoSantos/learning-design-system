...
interface IBoxProps extends ComponentProps<typeof Box> {
    as?: ElementType;
}
...
interface ITextProps extends ComponentProps<typeof Text> {
    as?: ElementType;
}
...
interface IHeadingProps extends ComponentProps<typeof Heading> {
    as?: ElementType;
}
...
declare function Avatar(props: IAvatarProps): JSX.Element;
...
interface ITextInputProps extends ComponentProps<typeof Input> {
    prefix?: string;
}
declare function TextInput({ prefix, ...props }: ITextInputProps): JSX.Element;
...
interface ITextAreaProps extends ComponentProps<typeof TextArea> {
}
...
interface ICheckboxProps extends ComponentProps<typeof CheckboxContainer> {
}
